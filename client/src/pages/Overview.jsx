        ...
        <section className="ov-section" aria-labelledby="heading-sandbox-quick">
          ...
          <div className="sandbox-ov-box">
            <div className="sandbox-controls-row">
              <span className="sandbox-label">Select Type:</span>
              ...
              <button
                type="button"
                className="ov-btn-primary sandbox-load-btn"
            ...
            <div className="sandbox-demo-box">
              ...
              {sandboxDoneResult ? (
                <div style={{ marginTop: "14px", display: "flex", flexDirection: "column", gap: "8px" }}>
                  <div className="sandbox-result-title">
                    <CheckCircle2 size={20} color="#16A34A" className="sandbox-result-icon" />
                    <span>
